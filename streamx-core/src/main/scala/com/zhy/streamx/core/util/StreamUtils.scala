...
import com.zhy.streamx.core.api.plugin.AbstractPlugin
...
import com.zhy.streamx.core.entity.{ConfigConf, StreamxConf}
...
/**
  ...
  **/
object StreamUtils {
    val DEFAULT_READER_NAME = "com.zhy.streamx.kafka.reader.KafkaReader"
    ...
    def initParser(cName: String): Parser = {
        ...
        cName match {
            case Key.JSON_PARSER =>
                instanceParserObj("com.zhy.streamx.core.parser.JsonParser")
            case Key.CSV_PARSER =>
                instanceParserObj("com.zhy.streamx.core.parser.CsvParser")
            case Key.CANAL_PARSER =>
                instanceParserObj("com.zhy.streamx.core.parser.CanalParser")
            case _ =>
