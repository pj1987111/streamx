package com.zhy.streamx.core.config
...
object ConfigParser {
    ...
    def main(args: Array[String]): Unit = {
        val config = StreamUtils.readConfig("local:/Volumes/workspace/zhy/pass_workspace/streamx/streamx-test/src/test/resources/data/${project.version}/error_test.json")
